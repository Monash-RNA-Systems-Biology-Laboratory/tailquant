...
* has_cds = Do any transcripts for this gene have a coding sequence?
* product = Text description of the function of the gene, protein it produces, etc.
* pos_vs_transcript_end = Location of site relative to most downstrand relevant transcript.
* pos_vs_cds_end = Location of site relative to end of most downstrand relevant CDS.
